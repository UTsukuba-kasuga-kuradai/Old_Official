...
$::wiki_title = '情報メディア創成学類、知識情報・図書館学類　クラス代表者会議';										# サイト名（なくても可）
#$::wiki_title{en}='';									# 英語時のタイトル(sample)
$::modifier = '情報メディア創成学類、知識情報・図書館学類　クラス代表者会議';								# 修正者名
$::modifierlink = '';									# 修正者URI
...
$::logo_width=80;										# 横幅
$::logo_height=80;										# 高さ
$::logo_alt="情報メディア創成学類、知識情報・図書館学類　クラス代表者会議";								# ロゴの代替文字
...
$::max_filesize = 100000000;	# アップロードファイルの容量
